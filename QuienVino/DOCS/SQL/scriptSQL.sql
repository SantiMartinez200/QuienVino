...
INSERT INTO `alumno` (`dni`, `nombre`, `apellido`, `fecha_nacimiento`) VALUES
	...
	(43149316, 'Franco Agustin', 'Chappe', '2000-12-12'),
	(43414566, 'Maximiliano', 'Weyler', '2000-12-12'),
	(43631710, 'Thiago Jeremias', 'Meseguer ', '2003-12-12'),
	(43631803, 'Bruno', 'Godoy ', '2003-12-12'),
	(43632750, 'Roman', 'Coletti', '2000-12-12'),
	...
	(45847922, 'Franco', 'Cabrera', '2000-12-12');
...
CREATE TABLE IF NOT EXISTS `asistencia` (
  ...
  CONSTRAINT `fk_dni_asistencia` FOREIGN KEY (`dni`) REFERENCES `alumno` (`dni`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
